 ...
 * Version: 0.11.0 - 2015-03-17T14:44:11.533Z
 * License: MIT
 */
...
$templateCache.put("fc-select/select.tpl.html","<div class=\"ui-select-container ui-select-fc\" ng-class=\"{\'select-focus\': $select.focus}\"><div class=\"ui-select-match\"></div><div dropdown-menu=\"\" class=\"dropdown-wrapper fade\" ng-show=\"$select.open\"><input ng-show=\"$select.searchEnabled\" type=\"text\" autocomplete=\"off\" tabindex=\"-1\" aria-expanded=\"true\" aria-label=\"{{ $select.baseTitle }}\" aria-owns=\"ui-select-choices-{{ $select.generatedId }}\" aria-activedescendant=\"ui-select-choices-row-{{ $select.generatedId }}-{{ $select.activeIndex }}\" class=\"ui-select-search\" ng-model=\"$select.search\"> <span ng-show=\"$select.searchEnabled\" icon=\"search\" class=\"icon-search\"></span><div class=\"ui-select-choices\"></div></div></div>");

 ...
 * Version: 0.11.0 - 2015-03-17T17:14:21.717Z
 * License: MIT
 */
  ...
  return {
    ...
    compile: function(tElement, tAttrs) {
      ...
      return function link(scope, element, attrs, $select, transcludeFn) {
        ...
        // Comment this line for animation
...
$templateCache.put("fc-select/match-multiple.tpl.html","<span class=\"ui-select-match\"><span ng-repeat=\"$item in $select.selected\"><span class=\"ui-select-match-item\" tabindex=\"-1\" type=\"button\" ng-disabled=\"$select.disabled\" ng-click=\"$select.activeMatchIndex = $index;\" ui-select-sort=\"$select.selected\"><span uis-transclude-append=\"\"></span></span></span></span>");
$templateCache.put("fc-select/match.tpl.html","<div class=\"ui-select-match\" ng-disabled=\"$select.disabled\"><span tabindex=\"-1\" class=\"ui-select-toggle\" aria-label=\"{{ $select.baseTitle }} activate\" ng-disabled=\"$select.disabled\" ng-click=\"$select.activate()\" style=\"outline: 0;\"><span ng-show=\"$select.isEmpty()\" class=\"ui-select-placeholder text-muted\">{{$select.placeholder}}</span> <span ng-hide=\"$select.isEmpty()\" class=\"ui-select-match-text pull-left\" ng-class=\"{\'ui-select-allow-clear\': $select.allowClear && !$select.isEmpty()}\" ng-transclude=\"\"></span> <i class=\"caret pull-right\" ng-click=\"$select.toggle($event)\"></i> <a ng-show=\"$select.allowClear && !$select.isEmpty()\" aria-label=\"{{ $select.baseTitle }} clear\" style=\"margin-right: 10px\" ng-click=\"$select.clear($event)\" class=\"pull-right\"><i class=\"glyphicon glyphicon-remove\" aria-hidden=\"true\"></i></a></span></div>");
$templateCache.put("fc-select/select-multiple.tpl.html","<div class=\"ui-select-container ui-select-multiple ui-select-fc\" ng-class=\"{open: $select.open}\"><div><div class=\"ui-select-match\"></div><input ng-hide=\"$select.disabled\" type=\"text\" autocomplete=\"off\" autocorrect=\"off\" autocapitalize=\"off\" spellcheck=\"false\" class=\"ui-select-search\" ng-disabled=\"$select.disabled\" ng-click=\"$select.activate()\" role=\"combobox\" aria-label=\"{{ $select.baseTitle }}\" ondrop=\"return false;\"></div><div ng-show=\"($select.items.length > 0) || ($select.searchEnabled && $select.open)\" dropdown-menu=\"\" class=\"dropdown-wrapper\"><input ng-show=\"$select.searchEnabled\" ng-if=\"!$select.inline\" type=\"text\" autocomplete=\"off\" autocorrect=\"off\" autocapitalize=\"off\" spellcheck=\"false\" class=\"ui-select-search-box\" ng-disabled=\"$select.disabled\" ng-model=\"$select.search\" role=\"combobox\" aria-label=\"{{ $select.baseTitle }}\" ondrop=\"return false;\"> <span ng-show=\"$select.searchEnabled\" icon=\"search\" class=\"icon-search\"></span><div class=\"ui-select-choices\"></div></div></div>");
$templateCache.put("fc-select/select.tpl.html","<div class=\"ui-select-container ui-select-fc\" ng-class=\"{\'select-focus\': $select.focus}\"><div class=\"ui-select-match\"></div><div dropdown-menu=\"\" class=\"dropdown-wrapper\" ng-show=\"$select.open\"><input ng-show=\"$select.searchEnabled\" type=\"text\" autocomplete=\"off\" tabindex=\"-1\" aria-expanded=\"true\" aria-label=\"{{ $select.baseTitle }}\" aria-owns=\"ui-select-choices-{{ $select.generatedId }}\" aria-activedescendant=\"ui-select-choices-row-{{ $select.generatedId }}-{{ $select.activeIndex }}\" class=\"ui-select-search\" ng-model=\"$select.search\"> <span ng-show=\"$select.searchEnabled\" icon=\"search\" class=\"icon-search\"></span><div class=\"ui-select-choices\"></div></div></div>");}]);
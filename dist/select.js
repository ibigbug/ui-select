 ...
 * Version: 0.11.0 - 2015-03-13T09:51:00.264Z
 * License: MIT
 */
...
$templateCache.put("fc-select/choices.tpl.html","<ul class=\"ui-select-choices ui-select-choices-content\" role=\"listbox\" ng-show=\"$select.items.length > 0\"><li class=\"ui-select-choices-group\" id=\"ui-select-choices-{{ $select.generatedId }}\"><div class=\"divider\" ng-show=\"$select.isGrouped && $index > 0\"></div><div ng-show=\"$select.isGrouped\" class=\"ui-select-choices-group-label\" ng-bind=\"$group.name\"></div><div id=\"ui-select-choices-row-{{ $select.generatedId }}-{{$index}}\" class=\"ui-select-choices-row\" ng-class=\"{active: $select.isActive(this), disabled: $select.isDisabled(this), selected: $select.isSelected(this)}\" role=\"option\"><a href=\"javascript:void(0)\" class=\"ui-select-choices-row-inner\"></a> <span ng-if=\"!$select.closeOnSelect\" href=\"javascript:void(0)\" class=\"ui-select-choices-check\" icon=\"check\"></span></div></li></ul>");
$templateCache.put("fc-select/match-multiple.tpl.html","<span class=\"ui-select-match\"><span ng-repeat=\"$item in $select.selected\"><span btn=\"grey\" class=\"ui-select-match-item\" tabindex=\"-1\" type=\"button\" ng-disabled=\"$select.disabled\" ng-click=\"$select.activeMatchIndex = $index;\" ui-select-sort=\"$select.selected\"><span uis-transclude-append=\"\"></span></span></span></span>");
$templateCache.put("fc-select/match.tpl.html","<div class=\"ui-select-match\" ng-disabled=\"$select.disabled\"><span tabindex=\"-1\" class=\"ui-select-toggle\" btn=\"square-outline grey\" aria-label=\"{{ $select.baseTitle }} activate\" ng-disabled=\"$select.disabled\" ng-click=\"$select.activate()\" style=\"outline: 0;\"><span ng-show=\"$select.isEmpty()\" class=\"ui-select-placeholder text-muted\">{{$select.placeholder}}</span> <span ng-hide=\"$select.isEmpty()\" class=\"ui-select-match-text pull-left\" ng-class=\"{\'ui-select-allow-clear\': $select.allowClear && !$select.isEmpty()}\" ng-transclude=\"\"></span> <i class=\"caret pull-right\" ng-click=\"$select.toggle($event)\"></i> <a ng-show=\"$select.allowClear && !$select.isEmpty()\" aria-label=\"{{ $select.baseTitle }} clear\" style=\"margin-right: 10px\" ng-click=\"$select.clear($event)\" btn=\"square-outline grey\" class=\"pull-right\"><i class=\"glyphicon glyphicon-remove\" aria-hidden=\"true\"></i></a></span></div>");
$templateCache.put("fc-select/select-multiple.tpl.html","<div input=\"text\" class=\"ui-select-container ui-select-multiple ui-select-fc\" ng-class=\"{open: $select.open}\"><div><div class=\"ui-select-match\"></div><input ng-hide=\"$select.disabled || $select.open\" type=\"text\" autocomplete=\"off\" autocorrect=\"off\" autocapitalize=\"off\" spellcheck=\"false\" class=\"ui-select-search\" ng-disabled=\"$select.disabled\" ng-click=\"$select.activate()\" role=\"combobox\" aria-label=\"{{ $select.baseTitle }}\" ondrop=\"return false;\"></div><div dropdown-menu=\"\" class=\"dropdown-wrapper\"><input ng-show=\"$select.searchEnabled\" ng-if=\"!$select.inline\" type=\"text\" autocomplete=\"off\" autocorrect=\"off\" autocapitalize=\"off\" spellcheck=\"false\" class=\"ui-select-search-box input-xs\" ng-disabled=\"$select.disabled\" ng-click=\"$select.activate()\" ng-model=\"$select.search\" role=\"combobox\" aria-label=\"{{ $select.baseTitle }}\" ondrop=\"return false;\"> <span ng-show=\"$select.searchEnabled\" icon=\"search\" class=\"icon-search\"></span><div class=\"ui-select-choices\"></div></div></div>");
$templateCache.put("fc-select/select.tpl.html","<div class=\"ui-select-container ui-select-fc\" ng-class=\"{open: $select.open, \'select-focus\': $select.focus}\"><div class=\"ui-select-match\"></div><div dropdown-menu=\"\" class=\"dropdown-wrapper\"><input ng-show=\"$select.searchEnabled\" type=\"text\" autocomplete=\"off\" tabindex=\"-1\" aria-expanded=\"true\" aria-label=\"{{ $select.baseTitle }}\" aria-owns=\"ui-select-choices-{{ $select.generatedId }}\" aria-activedescendant=\"ui-select-choices-row-{{ $select.generatedId }}-{{ $select.activeIndex }}\" class=\"ui-select-search\" ng-model=\"$select.search\"> <span ng-show=\"$select.searchEnabled\" icon=\"search\" class=\"icon-search\"></span><div class=\"ui-select-choices\"></div></div></div>");
